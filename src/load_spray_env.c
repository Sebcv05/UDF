...
CONVERGE_ONLOAD(spray_env, IN(CONVERGE_VOID))
{
   ...
   CONVERGE_variable_register("time_since_injection",CONVERGE_DOUBLE,DEFAULT_PARCEL_VARIABLE_SETTINGS,END_ARG_LIST);
...
void load_user_cloud(struct ParcelCloud *parcel_cloud_loc, CONVERGE_cloud_t c)
{
   ...
   parcel_cloud_loc->time_since_injection = (CONVERGE_precision_t *)CONVERGE_cloud_get_field_data(c,TIME_SINCE_INJECTION);
