             ...
             OUT(CONVERGE_VOID))
{
   ...
   if (parcel_cloud.breakup_phase[passed_parent_parcel_idx] != 0)  // Parent underwent some form of breakup
   {
      ...
      parcel_cloud.uu[passed_child_parcel_idx][0] = user_child_velocity_x*5.0;
      parcel_cloud.uu[passed_child_parcel_idx][1] = user_child_velocity_y*5.0;
      parcel_cloud.uu[passed_child_parcel_idx][2] = user_child_velocity_z*5.0;
      
      parcel_cloud.uu_tm1[passed_child_parcel_idx][0] = user_child_velocity_x*5.0;
      parcel_cloud.uu_tm1[passed_child_parcel_idx][1] = user_child_velocity_y*5.0;
      parcel_cloud.uu_tm1[passed_child_parcel_idx][2] = user_child_velocity_z*5.0;
